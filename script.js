...
let currentMode='declaracao', slideTimer=null, counterInterval=null, heartsInterval=null;
...
function buildWhiteBoxWithButtons(parent,{heading,idSuffix,items}){
  ...
  const h2=document.createElement('h2'); h2.textContent
